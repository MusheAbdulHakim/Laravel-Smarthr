...
$(document).ready(function () {
    ...
    $(".toggle-password").click(function () {
        $(this).toggleClass("fa-eye fa-eye-slash");
        if (
            $(this).closest('input[type="password"]').attr("type") == "password"
        ) {
            $(this).closest('input[type="password"]').attr("type", "text");
        } else {
            $(this).closest('input[type="password"]').attr("type", "password");
        }
    });
    ...
    $(document).ready(function () {
        $("[data-layout=horizontal] #sidebar-size-small-hover").click(
            function () {
                $("html").attr("data-layout", "vertical");
            }
        );
