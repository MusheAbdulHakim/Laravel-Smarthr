...
@section('page-content')
    <div class="content container-fluid">
        ...
        <!-- Page Header -->
        <x-breadcrumb>
            <x-slot name="title">{{ __('Create Estimate') }}</x-slot>
            <ul class="breadcrumb">
            ...
            <div class="col-sm-12">
                <form action="{{ route('estimates.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div x-data="{
                        ...
                        setTax: function(e){
                            if(e){
                                this.taxPercentage = this.subtotalVal * (e/100)
                            }
                        },
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end tdata-width pe-4">
                                                    <input type="text" :value="subtotalVal+taxPercentage-discount" class="form-control text-end" name="grand_total" readonly>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>                               
