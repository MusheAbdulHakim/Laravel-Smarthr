<x-table-action>
    <a class="dropdown-item" href="javascript:void(0)" data-url="{{ route('expenses.edit', $id) }}" data-ajax-modal="true"
    ...
    <a class="dropdown-item deleteBtn" data-route="{{ route('expenses.destroy', $id) }}" data-title="{{ __('Delete Expense') }}"
