...
<ul class="navbar-nav mb-1">
    ...
    <li class="nav-item dropdown">
        <a id="user_nav_dp" href="#" class="dropdown-toggle nav-link pb-lg-0" data-toggle="dropdown" role="button" aria-expanded="false">
            <img class="rounded align-top my-n2 my-global-avatar" id="navProf_pic" height="38" width="38" src="{{!empty(messenger()->getProvider()) ? messenger()->getProvider()->getProviderAvatarRoute(): asset('images/user.jpg')}}">
