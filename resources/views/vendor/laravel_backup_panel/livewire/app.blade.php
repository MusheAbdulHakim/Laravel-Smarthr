<div class="container mb-5">
    <div class="d-flex align-items-end pt-4">
        ...
        <button id="create-backup" class="btn btn-primary btn-sm ms-auto px-3">
            Create Backup
        </button>
        ...
        <div class="col-12">
            <div class="card shadow-sm mb-4">
                <div class="card-header d-flex align-items-end">
                    <button class="btn btn-primary btn-sm btn-refresh ms-auto"
            ...
            <div class="card shadow-sm">
                <div class="card-header d-flex align-items-end">
                    ...
                    <button class="btn btn-primary btn-refresh ms-auto"
                            wire:loading.class="loading"
                            wire:loading.attr="disabled"
                            wire:click="getFiles"
                            {{ $activeDisk ? '' : 'disabled' }}
