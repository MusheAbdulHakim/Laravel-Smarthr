                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="avatar-container">
                                                <img class="avatar-edit rounded-circle" src="" alt="Client Picture" style="width: 100px; height: 100px;">
                                            </div>
    ...
    <script>
        $(document).ready(function () {
            $('.editbtn').on('click', function () {
                ...
                // Set image source for the avatar
                if (avatar) {
                    $('.avatar-edit').attr('src', '{{ asset('storage/clients/') }}/' + avatar);
                } else {
                    $('.avatar-edit').attr('src', '{{ asset('assets/img/profiles/default.jpg') }}');
                }
            });
        });
    </script>
